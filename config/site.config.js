...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'efq0a0036@miku.re',
  ...
  protectedRoutes: ['/Sync', '/🌞 Private folder/u-need-a-password', '/🥟 Some test files/Protected route'],
